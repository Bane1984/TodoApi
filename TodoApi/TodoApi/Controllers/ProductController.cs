...
namespace TodoApi.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        // GET: api/product/p/{id}
        [HttpGet("p/{id}")]   //rutiranje mi nij radilo za ovaj poziv zato sto je u metodi ispod, promnljiva id je bila razlicitog tipa od tipa definisanog u metodi - nepaznja
